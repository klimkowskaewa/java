...
public class MonteChristo {
    public static void main(String[] args) {
        ...
        List<String> allLines = mc.loadTextFile("src/collections/crsto10.txt");
    ...
    void showTheLongestVerse(List<String> allLines) {
        ...
        System.out.println("\nNajdłuższym wiersz w książce zawiera: " + longestLine.length() + " znaki/znaków - " + longestLine.toUpperCase());
    }
}
